import './App.css';
import SimpsonsComponent from "./components/SimpsonsComponent.jsx";
...
const App = () => {
    const simpsonsComponents = simpsons.map((simpson) => (
        <SimpsonsComponent
            name={simpson.name}
    ...
    return <div className='Main'>{simpsonsComponents}</div>;
};
